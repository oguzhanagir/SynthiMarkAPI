...
{
    public class PostIdeasReadRepository : ReadRepository<PostIdeas>, IPostIdeasReadRepository
    {
        public PostIdeasReadRepository(SynthiMarkAPIDbContext context) : base(context)
        {
        }
    }
}

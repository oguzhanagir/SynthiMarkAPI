...
{
    public class VideoIdeasReadRepository : ReadRepository<VideoIdeas>, IVideoIdeasReadRepository
    {
        public VideoIdeasReadRepository(SynthiMarkAPIDbContext context) : base(context)
        {
        }
    }
}

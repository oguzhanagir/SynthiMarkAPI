...
{
    public class AdvertisingWriteRepository : WriteRepository<Advertising>, IAdvertisingWriteRepository
    {
        public AdvertisingWriteRepository(SynthiMarkAPIDbContext context) : base(context)
        {
        }
    }
}
